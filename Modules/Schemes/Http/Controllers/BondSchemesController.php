...
class BondSchemesController extends Controller
{
    /**
    ...
    {
        try {
            $list = BondScheme::orderBy('name')->get();
    ...
    {
        try {
            $scheme = BondScheme::find($request->id);
    ...
    private function __fill(BondScheme $scheme, $request)
    {
