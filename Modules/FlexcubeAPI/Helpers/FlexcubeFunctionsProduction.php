...
use Modules\FlexcubeAPI\App\Models\TransactionBatch;
use Modules\Payments\Entities\Payment;
use Modules\Receipts\Entities\Receipt;
use Modules\Securities\Entities\Security;

class FlexcubeFunctionsProduction
{
    ...
    private static function generatePayloadContractNoteStockCustodian(SimpleTransaction $simpleTransaction, Transaction $transaction, DealingSheet $payloadRaw): string
    {
        ...
        $payload = [
            ...
            "Multioffsetmaster-Full" => [
                ...
                "DE_DR_CR" => "D",
                "DE_AMOUNT" => $payloadRaw->total_fees,
                "DE_EXCH_RATE" => "1",
                "DE_LCY_AMOUNT" => $payloadRaw->total_fees,
                "MAKERID" => "",
                "DE_AUTHORIZED_BY" => "",
        ...
        $payload = [
            ...
            "Multioffsetmaster-Full" => [
               ...
               "DE_INSTRUMENT_NUMBER" => str_ireplace("/","",$payloadRaw->reference),
                "MAKERID" => "",
                "DE_AUTHORIZED_BY" => "",
                 "DE_DATETIME" => date("Y-m-d",strtotime($payloadRaw->date)),
                "AUTHSTAT" => "",
                "DE_MAKER_DATETIME" => "",
...
//             "DE_ACCNO" => $customer->flex_acc_no,
    ...
    {
        return "http://192.168.1.30:9001/ITRUSTAPIDE/v1/api";
    }
...
//            }
           ...
           $checkInput = json_encode($payload);
           $check = FlexcubeTransactions::where("instrument_code",$checkInput->DE_INSTRUMENT_NUMBER)->first();
...
//            \Log::info($response->body());
    ...
    private static function _getTotalChargesStock(DealingSheet $dealingSheet): float
    {
