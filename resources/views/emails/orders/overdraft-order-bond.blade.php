                                                            ...
                                                            <td align="center" class="esd-block-text" esd-links-underline="none">
                                                                <table border="1" bordercolor="#cccccc" align="center" cellspacing="5" cellpadding="5" style="height:100px;width:500px;" class="es-table">
                                                                    ...
                                                                    <tr style="background-color: #E0E1FD; height:50px">
                                                                        ...
                                                                        <td style="font-family: manrope, arial, sans-serif; text-align: center; font-size: 14px;">Face Value</td>
                                                                    ...
                                                                    @php
                                                                        $orders = \Modules\Bonds\Entities\BondOrder::where("status","overdraft")->orderBy("created_at")->get()
                                                                    @endphp
                                                                    @if(!empty($orders))
                                                                        @foreach($orders as $key => $order)
                                                                            <tr style="height:50px">
                                                                                ...
                                                                                <td style="text-align: center; font-family: manrope, arial, sans-serif; font-size: 12px;">{{number_format($order->face_value,2)}}</td>
