...
class IncomeMonthlyExport implements FromQuery, WithHeadings, WithMapping, WithStyles, WithTitle
{
    use Exportable;
    ...
    public function query()
    {
        $data = Transaction::query()
            ...
            ->whereDate('transaction_date', '<=', $this->end)->whereDate('transaction_date', '>=', $this->from)->where('status', 'approved')->whereIn('class_id', [10]);
    ...
    public function map($data): array
    {
        ...
        return [
            Account::find($data->account_id)->name,
