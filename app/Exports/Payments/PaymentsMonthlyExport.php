...
class PaymentsMonthlyExport implements FromQuery, WithHeadings, WithMapping, WithStyles, WithTitle
{
    use Exportable;
    ...
    public function query()
    {
        $data = Transaction::query()
            ...
            ->whereDate('transaction_date', '<=', $this->end)
            ->whereDate('transaction_date', '>=', $this->from)
