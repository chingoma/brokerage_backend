...
class PaymentsCustomExport implements FromQuery, WithHeadings, WithMapping, WithStyles, WithTitle
{
    use Exportable;
    ...
    public function query(): Builder
    {
        $data = Transaction::query()
            ...
            ->PaymentsReport()->groupBy('reference')->whereDate('transaction_date', '<=', $this->end)->whereDate('transaction_date', '>=', $this->from)->where('status', 'approved');
