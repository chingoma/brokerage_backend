...
class CustomersExportCreditors implements FromQuery, WithColumnFormatting, WithHeadings, WithMapping, WithStyles
{
    use Exportable;
    ...
    public function query()
    {
        ...
        $data = User::customers()->query()->whereIn('id', $ids)->latest();
