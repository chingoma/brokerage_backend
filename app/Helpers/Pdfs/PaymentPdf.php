...
class PaymentPdf extends TCPDF
{
    ...
    public function create(Transaction $transaction): string
    {
        ...
        $this->Cell(w: '', h: '', txt: 'PAYMENT', ln: 1, align: 'C');
        $this->Ln(7);
        ...
        $this->MultiCell(45, 7, 'Cheque Number', 1, 'C', 0, 0, '', '', true, valign: 'M');
        ...
        $this->MultiCell(45, 7, $transaction->cheque_number, 1, 'C', 0, 0, '', '', true, valign: 'M');
        ...
        // This method has several options, check the source code documentation for more information.
        $this->Output(public_path('files/payment.pdf'), 'F');
        $this->file = asset('files/payment.pdf');

        return public_path('files/payment.pdf');
    }
}
