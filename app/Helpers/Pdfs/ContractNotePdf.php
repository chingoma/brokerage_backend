...
class ContractNotePdf extends TCPDF
{
    ...
    public function create(Order $order, DealingSheet $dealingSheet): string
    {
        ...
        $this->scheme = \DB::table('equity_schemes')->find($this->category->equity_scheme);
        ...
        $this->MultiCell(135, 5, ': '.strtoupper($order->security->name), 0, 'L', 0, 1, '', '', true, valign: 'M');
        $this->MultiCell(45, 5, 'Total Order Quantity', 0, 'L', 0, 0, '', '', true, valign: 'M');
        $this->MultiCell(135, 5, ': '.number_format($order->volume), 0, 'L', 0, 1, '', '', true, valign: 'M');
        $this->MultiCell(45, 5, 'No. Shares Traded', 0, 'L', 0, 0, '', '', true, valign: 'M');
        $this->MultiCell(135, 5, ': '.number_format($dealingSheet->executed), 0, 'L', 0, 1, '', '', true, valign: 'M');
        $this->MultiCell(45, 5, 'Balance Order Quantity', 0, 'L', 0, 0, '', '', true, valign: 'M');
        $this->MultiCell(135, 5, ': '.number_format($dealingSheet->balance), 0, 'L', 0, 1, '', '', true, valign: 'M');
        $this->MultiCell(45, 5, 'Average Transaction Price', 0, 'L', 0, 0, '', '', true, valign: 'M');
        $this->MultiCell(135, 5, ': '.number_format($dealingSheet->price), 0, 'L', 0, 1, '', '', true, valign: 'M');

        $this->Ln(2);
        $this->SetFont($this->font, 'B', 8, '', true);
        $this->MultiCell(60, 4, 'Gross Consideration', 1, 'L', 0, 0, '', '', true, valign: 'M');
        $this->MultiCell(60, 4, number_format($dealingSheet->executed).' @ '.number_format($dealingSheet->price), 1, 'L', 0, 0, '', '', true, valign: 'M');
        $this->MultiCell(60, 4, number_format($dealingSheet->price * $dealingSheet->executed, 2), 1, 'R', 0, 1, '', '', true, valign: 'M');
        $this->SetFont($this->font, '', 7, '', true);

        if ($dealingSheet->commission_step_one > 0) {
            $this->MultiCell(60, 4, 'Brokerage Commission up to TZS 10mn', 1, 'L', 0, 0, '', '', true, valign: 'M');
            $this->MultiCell(60, 4, '1.7% ', 1, 'L', 0, 0, '', '', true, valign: 'M');
            ...
            $this->MultiCell(60, 4, '1.5% ', 1, 'L', 0, 0, '', '', true, valign: 'M');
        ...
        $this->MultiCell(60, 4, '0.14% ', 1, 'L', 0, 0, '', '', true, valign: 'M');
        ...
        $this->MultiCell(60, 4, '0.0708%', 1, 'L', 0, 0, '', '', true, valign: 'M');
        ...
        $this->MultiCell(60, 4, ' -  ', 1, 'L', 0, 0, '', '', true, valign: 'M');
        $this->MultiCell(60, 4, number_format($dealingSheet->total_fees, 2), 1, 'R', 0, 1, '', '', true, valign: 'M');
        ...
        $this->Ln(3);
        $this->SetFont($this->font, 'BU', 7, '', true);
        $this->MultiCell(0, 5, 'Contract and Order Details', 0, 'C', 0, 1, '', '', true, true, valign: 'L');
        $this->SetFont($this->font, '', 7, '', true);
        $this->Ln(3);
        ...
        $string = str_ireplace(' ', '', $dealingSheet->slip_no);
        $string = trim(str_ireplace(',', '', $string));
        $slipNo = wordwrap($string, 9, ' ', true);
        $parts = explode(' ', $slipNo);
        $rowheight = (4 * count($parts)) - 1;
        ...
        $this->MultiCell(25.72, $rowheight, $slipNo, 1, 'C', 0, 0, '', '', true, true, valign: 'M');
        $this->MultiCell(25.72, $rowheight, $dealingSheet->uid, 1, 'C', 0, 0, '', '', true, true, valign: 'M');
        $this->MultiCell(25.72, $rowheight, number_format($order->volume), 1, 'C', 0, 0, '', '', true, true, valign: 'M');
        $this->MultiCell(25.72, $rowheight, number_format($dealingSheet->executed), 1, 'C', 0, 0, '', '', true, true, valign: 'M');
        $this->MultiCell(25.72, $rowheight, number_format($dealingSheet->balance), 1, 'C', 0, 1, '', '', true, true, valign: 'M');
